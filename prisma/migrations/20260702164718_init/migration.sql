-- CreateEnum
CREATE TYPE "Tier" AS ENUM ('APPRENTICE', 'JOURNEYMAN', 'MASTER', 'HERO');
...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "passwordHash" TEXT,
    "tier" "Tier" NOT NULL DEFAULT 'APPRENTICE',
    "subscriptionStartDate" TIMESTAMP(3),
    "successfulBillingCount" INTEGER NOT NULL DEFAULT 0,
    "subscriptionStatus" "SubscriptionStatus" NOT NULL DEFAULT 'INACTIVE',
    "aiUsageCount" INTEGER NOT NULL DEFAULT 0,
    "aiUsageResetDate" TIMESTAMP(3),
...
CREATE TABLE "Module" (
    ...
    "requiredTier" "Tier" NOT NULL DEFAULT 'APPRENTICE',
